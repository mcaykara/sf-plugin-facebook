...
public:
     ...
     */
    ProjectJson(bool encrypted, string cipherKey = "");
    /**
...
class ProjectJsonException : public exception {
public:
    ProjectJsonException(string message = "There is a problem with project.json file") {
