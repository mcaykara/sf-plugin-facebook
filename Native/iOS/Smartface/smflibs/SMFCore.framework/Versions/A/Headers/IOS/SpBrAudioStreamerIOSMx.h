...
//BOOL interruptedOnAudioPlayback;
...
} SpBrAudioStreamerIOSMxStopReason;
...
} SpBrAudioStreamerIOSMxErrorCode;

extern NSString * const ASStatusChangedNotification;

@interface SpBrAudioStreamerIOSMx : NSObject
{
	NSURL *url;
	...
	SpBrAudioStreamerIOSMxState state;
	SpBrAudioStreamerIOSMxStopReason stopReason;
	SpBrAudioStreamerIOSMxErrorCode errorCode;
	OSStatus err;
...
@property SpBrAudioStreamerIOSMxErrorCode errorCode;
@property (readonly) SpBrAudioStreamerIOSMxState state;
