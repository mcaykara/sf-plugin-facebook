...
enum TEventID
{
    ...
    EEIDOnRequestPermissionsResult,
    ...
    EEIDOnContactPickedSuccess,
    EEIDOnGetAllContactsSuccess,
    EEIDOnGalleryPickSuccess,
    EEIDOnGetAllGalleryItemsSuccess,
...
public:
    ...
    bool HasEvent(TEventID aEventID, int aOption = -1);
    bool HasBlackWholeEvent(TEventID aEventID);
    ...
    void PrintEvents();
    void AddJSCallbackEvent(int eventCode, SpJsObject callbackFunction,SpDataBridge* db=NULL);
    void AddCallbackEvent(int eventCode, void* (*foo)(void*),void* data, SpDataBridge* db=NULL);
    ...
    void BindDynamicJSCallbackEvent(int eventCode, SpJsObject callbackFunction,SpDataBridge* db=NULL);
...
private:
    ...
    SpDataBridge* jsEventReturnDataBridge;
