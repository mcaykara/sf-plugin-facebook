...
#define ELEMENT_ID_WEBCLIENT			46
#define ELEMENT_ID_ACTIVITY_INDICATOR   47
#define ELEMENT_ID_ADMOB                48
...
#define ELEMENT_ID_NAVIGATIONITEM       204
#define ELEMENT_ID_BARBUTTONITEM        205
...
class SpBrNuiFactory {
	...
	public:
        ...
        static SpBrParcelable* GetClone(SpBrNuiBase **sourceObject, bool deepClone);
        static SpJsClassDefinition* GetClassDefFromType(int type);
        static SpJsClassDefinition* GetClassDef(const SpBrParcelable* object);
};
